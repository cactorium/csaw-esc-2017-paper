...
We attempt to frame the problem as a machine learning one, as trying to distinguish signals originating in normal operation from those originating in compromised devices.
...
\begin{figure}
  \centering
  \includegraphics[width=\columnwidth]{coffee.png}
  \label{fig:coffee}
